    ...
    <div className="min-h-screen bg-slate-100 flex flex-col">
      <header className="h-16 md:h-20 bg-white border-b border-black/5 flex items-center justify-between px-4 md:px-8 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={() => onLogin()}
            className="px-4 md:px-6 py-2 md:py-2.5 rounded-xl font-semibold text-xs md:text-sm hover:bg-slate-50 transition-all border border-black/5"
          >
            Kirjaudu sisään
          </button>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
        <div className="max-w-4xl w-full text-center mt-8 md:mt-0 mb-12 md:mb-16">
          <h1 className="text-3xl md:text-5xl font-black tracking-tighter mb-4 md:mb-6">SUUNNITTELE LIIKETOIMINTASI</h1>
